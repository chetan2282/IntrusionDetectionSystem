...
<body>
	...
	<div id="tooplate_wrapper">
		...
		<div id="tooplate_main_wrapper">
			...
			<tr><td><font color="green"><h3>Sr No.</h3></font></td>
			<td><font color="green"><h3>Sender</h3></font></td>
			
			<td><font color="green"><h3>Filename</h3></font></td>
			<td><font color="green"><h3>Action</h3></font></td>
			</tr>
			<%
			int sr = 0;
			...
			PreparedStatement ps1 = con.prepareStatement("select * from malicious_signatures");
			...
			System.out.println("hiii");
			PreparedStatement ps = con.prepareStatement("select * from destination_files where receiver = '"+username+"' or signature !='"+sign+"'");
			...
			while(rs.next()){
				...
				<td><a href="DownloadServlet?fileId=<%=fileId%>">Download</a></td>
				</tr>
				<%
			}
			break;
