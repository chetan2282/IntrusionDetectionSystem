	...
	<div id="tooplate_wrapper">
		...
		<div id="tooplate_main_wrapper">
          ...
          <form action="reg" method="post" name="uRegi"  onsubmit="return Regvalidation()">
            <center><table>
            <tr>
            <td><strong>First Name</strong></td><td><input type="text" name="fname" maxlength="10" required id="fname"></input>&nbsp;&nbsp;&nbsp;</td>
            <td><strong>Middle Name</strong></td><td><input type="text" name="mname" maxlength="10" required id= "mname"></input>&nbsp;&nbsp;&nbsp;</td>
            <td><strong>Last Name</strong></td><td><input type="text" name="lname" id= "lname" maxlength="10" required></input>&nbsp;&nbsp;&nbsp;</td>
            </tr>
           ...
           <tr></tr>
            ...
            <tr>
            <td><strong>Address</strong></td><td><input type="text" name="address" required id="address" maxlength="10"></input></td>
           ...
           <tr></tr>
            ...
            <tr>
            <td><strong>Email Id</strong></td><td><input type="text"  name="email" required id="email" maxlength="30"></input></td>
            <td><strong>Mobile no</strong></td><td><input type="text" name="mobile" id="txtMB"pattern="[7|8|9][0-9]{9}" maxlength="10" title="Phone number Start with 7 or 8 or 9" required "></input></td>
            </tr>
            <tr></tr>
            <tr></tr>
            <tr></tr>
