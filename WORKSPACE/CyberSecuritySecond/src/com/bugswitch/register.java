	...
	String password;
		...
		public void doPost(HttpServletRequest req,HttpServletResponse res)
		{
			...
			try 
			{
				...
				ps=con.prepareStatement("insert into mem_info(firstname,middlename,lastname,dob,gender,address,city,email,mobile,username,password)"+"values(?,?,?,?,?,?,?,?,?,?,?)");
				...
				if (result > 0)
				{
					...
					res.sendRedirect("index.jsp?registered");
